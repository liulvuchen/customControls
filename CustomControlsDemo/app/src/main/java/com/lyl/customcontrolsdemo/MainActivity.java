package com.lyl.customcontrolsdemo;
...
import com.lyl.customcontrolsdemo.bean.PickerViewData;
import com.lyl.customcontrolsdemo.bean.ProvinceBean;
import com.lyl.pickerview.OptionsPickerView;
import com.lyl.pickerview.TimePickerView;
import com.lyl.pickerview.model.IPickerViewData;
...
/**
 * 详细介绍
 *OptionsPickerView添加数据，三级的话 每个都要添加进入
 */
...
//        pvTime.setRange(calendar.get(Calendar.YEAR) - 20, calendar.get(Calendar.YEAR));//要在setTime 之前才有效果哦
        ...
        options1Items.add(new ProvinceBean(2,"石晶","嗯1111～～",""));
        ...
        ArrayList<IPickerViewData> options3Items_04_01=new ArrayList<>();
        options3Items_04_01.add(new PickerViewData("好2222"));
        options3Items_04.add(options3Items_04_01);
